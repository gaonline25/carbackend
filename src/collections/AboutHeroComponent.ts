...
export const AboutHeroComponent: CollectionConfig = {
  ...
  fields: [
    ...
    // Content Section (New Dynamic Rich Text Section)
    {
      name: 'contentSection',
      type: 'group',
      ...
      fields: [
        ...
        },
        {
          ...
          admin: {
            description:
              'Enter your full content here, including headings, paragraphs, lists, images, and embeds (e.g., iframes for maps/videos). Use the rich text editor to add figures for images and videos.',
          },
        },
      ],
    },
    // Tabs Section (Kept in config but not rendered in component since removed from page)
    {
      name: 'tabsSection',
      type: 'group',
      label: 'Tabs Section',
